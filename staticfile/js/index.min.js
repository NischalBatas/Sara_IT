  ...
  var e = {
      ...
      90: (e) => {
        ...
        e.exports = function (e, i, n) {
          ...
          "function" == typeof i && ((n = i), (i = {})),
            (i = i || {}),
            (n = n || function () {}),
            (a.type = i.type || "text/javascript"),
            (a.charset = i.charset || "utf8"),
            (a.async = !("async" in i) || !!i.async),
            (a.src = e),
            i.attrs &&
              (function (e, t) {
                for (var s in t) e.setAttribute(s, t[s]);
              })(a, i.attrs),
            i.text && (a.text = "" + i.text),
            ("onload" in a ? t : s)(a, n),
            a.onload || t(a, n),
            r.appendChild(a);
        };
      ...
      988: (e) => {
         ...
         */ (t = function () {
          ...
          return (
            (e.on = function (e, s) {
              var i = { name: e, handler: s };
              return (t[e] = t[e] || []), t[e].unshift(i), i;
            }),
            (e.off = function (e) {
              var s = t[e.name].indexOf(e);
              -1 !== s && t[e.name].splice(s, 1);
            }),
            (e.trigger = function (e, s) {
              var i,
                n = t[e];
              if (n) for (i = n.length; i--; ) n[i].handler(s);
            }),
            e
          );
        }),
        ...
        var l = (0, i.default)("youtube-player"),
          d = {
            proxyEvents: function (e) {
              ...
              try {
                for (
                  var o, d = r.default[Symbol.iterator]();
                  !(i = (o = d.next()).done);
                  i = !0
                ) {
                  s(o.value);
            ...
            promisifyPlayer: function (e) {
              var t =
                ...
                i = function (i) {
                  t && a.default[i]
                    ? (s[i] = function () {
                        for (
                          var t = arguments.length, s = Array(t), n = 0;
                          n < t;
                          n++
                        )
                          s[n] = arguments[n];
              ...
              try {
                for (
                  var d, c = n.default[Symbol.iterator]();
                  !(r = (d = c.next()).done);
                  r = !0
                ) {
                  var p = d.value;
  ...
  (() => {
    ...
    function i(e = {}, s = {}) {
      Object.keys(s).forEach((n) => {
        void 0 === e[n]
          ? (e[n] = s[n])
          : t(s[n]) && t(e[n]) && Object.keys(s[n]).length > 0 && i(e[n], s[n]);
      });
    }
    const n = {
      body: {},
    ...
    function _(e) {
      ...
      if (!s.allowTouchMove)
        return (
          m(d.target).is(i.focusableElements) || (s.allowClick = !1),
          void (
            i.isTouched &&
            (Object.assign(a, {
              startX: p,
    ...
    function ae(t) {
      for (var s = 1; s < arguments.length; s++) {
        ...
        s % 2
          ? re(Object(i), !0).forEach(function (s) {
              e(t, s, i[s]);
            })
          : Object.getOwnPropertyDescriptors
          ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(i))
          : re(Object(i)).forEach(function (e) {
    ...
    ee.use([
              ...
              for (let e = 0, t = i.length; e < t; e += 1) {
                ...
                if (
                  ...
                  0 === e.length && (e = ie(r, t, a ? "left" : "top")),
                    0 === s.length && (s = ie(r, t, a ? "right" : "bottom")),
      ...
      function (e) {
        ...
        function c() {
          ...
          if (
            ("fraction" === s.type &&
              (r.find(se(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      (e = ".chart_slider"),
        ...
        (s = {
          ...
          breakpoints: { 767.98: { spaceBetween: 0 } },
        }),
